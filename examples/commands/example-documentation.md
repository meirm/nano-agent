...
nano-cli /documentation "$(cat src/api.py)"

# Generate README for project
nano-cli /documentation "Generate README for this Python project with setup and usage"

# Document an API endpoint
nano-cli /documentation "$(cat routes/users.py)"
```
...
nano-cli /documentation "$(cat app/api/routes.py)"

# Generate comprehensive project docs
nano-cli /documentation "Create full documentation for this FastAPI application"
```
