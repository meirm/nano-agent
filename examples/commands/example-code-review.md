...
# Review inline code
nano-cli /code-review "def process(data): return data * 2"

# Review multiple files
nano-cli /code-review "$(cat src/*.py)"
```
...
nano-cli /code-review "$(sed -n '10,30p' app.py)"

# Review an entire module
nano-cli /code-review "$(cat utils/helpers.py)"
```
