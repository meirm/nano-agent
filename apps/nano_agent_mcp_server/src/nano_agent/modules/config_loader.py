"""
Configuration Loader for Nano Agent CLI and MCP Server.
...
def load_nano_cli_config(working_dir: Optional[Path] = None) -> LoadedConfiguration:
    """Load configuration for nano-cli binary."""
    return load_configuration(BinaryType.NANO_CLI, working_dir)


def load_nano_agent_config(working_dir: Optional[Path] = None) -> LoadedConfiguration:
    """Load configuration for nano-agent binary."""
    return load_configuration(BinaryType.NANO_AGENT, working_dir)
