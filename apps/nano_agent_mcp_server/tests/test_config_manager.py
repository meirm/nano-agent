...
class TestConfigManager:
    ...
    def test_environment_variable_loading(self):
        ...
        with patch.dict(os.environ, {
            "NANO_AGENT_DEFAULT_PROVIDER": "env-provider",
            "NANO_AGENT_DEFAULT_MODEL": "env-model",
            "NANO_AGENT_LOG_LEVEL": "WARNING",
            "NANO_AGENT_CACHE_TTL": "1800",
            "NANO_AGENT_PROVIDER_OLLAMA_API_BASE": "http://custom:11434"
        }):
            manager = ConfigManager()
            config = manager.load_config()
    ...
    def test_project_config_discovery(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            config_file = tmpdir_path / ".nano-agent.yaml"
    ...
    def test_save_user_config(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            mock_user_dir = Path(tmpdir) / ".config" / "nano-agent"
            ...
            config = NanoAgentConfig(
                default_provider="saved-provider",
    ...
    def test_save_project_config(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                ...
                manager = ConfigManager()
                config = NanoAgentConfig(
                    default_provider="project-saved",
                    log_level="DEBUG"
                )
                manager.save_project_config(config)
                
                # Verify file was created
                config_file = Path(tmpdir) / ".nano-agent.yaml"
    ...
    def test_get_config_sources(self):
        ...
        with patch.dict(os.environ, {"NANO_AGENT_DEFAULT_MODEL": "test"}):
