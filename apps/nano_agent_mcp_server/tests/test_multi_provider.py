...
import pytest
from nano_agent.modules.constants import (AVAILABLE_MODELS,
...
class TestProviderConfig:
    ...
    def test_create_agent_anthropic(self):
        ...
        with patch("nano_agent.modules.provider_config.Agent") as MockAgent, patch(
            "nano_agent.modules.provider_config.AsyncOpenAI"
    ...
    def test_setup_provider_disables_tracing_non_openai(self):
        ...
        with patch.dict(os.environ, {}, clear=True), patch(
            "nano_agent.modules.provider_config.set_tracing_disabled"
        ) as mock_disable:
