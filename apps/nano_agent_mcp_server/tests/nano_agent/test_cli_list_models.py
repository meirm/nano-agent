...
from nano_agent.cli import app
...
class TestListModelsCommand:
    ...
    def test_list_models_json_output(self):
        ...
        result = runner.invoke(app, ["list-models", "--provider", "anthropic", "--format", "json"])
    ...
    @pytest.mark.skipif(not os.environ.get("OLLAMA_API_URL"), reason="Ollama not available")
    ...
    def test_list_models_verbose(self):
        """Test verbose output."""
        result = runner.invoke(app, ["list-models", "--provider", "anthropic", "--verbose"])
    ...
    def test_list_models_filter_by_capability(self):
        ...
        result = runner.invoke(app, ["list-models", "--provider", "anthropic", "--capability", "chat", "--format", "json"])
    ...
    def test_list_models_show_deprecated(self):
        ...
        result = runner.invoke(app, ["list-models", "--provider", "anthropic", "--show-deprecated", "--format", "json"])
