...
1. Load global commands from ~/.nano-cli/commands/*.md
2. Load project commands from .nano-cli/commands/*.md  
...
# from nano_agent.modules.command_loader import CommandLoader, CascadeCommandLoader
...
"""
    ...
    def test_command_override_cascade(self, sample_global_commands, sample_project_commands):
...
"""
    ...
    def test_cli_command_parsing_integration(self):
        ...
        for test_input, expected in zip(test_inputs, expected_results):
            ...
            from nano_agent.modules.command_loader import parse_command_syntax
