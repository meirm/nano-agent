    ...
    async def test_provider_cache_invalidation(self):
        ...
        class CachedProvider(ModelProvider):
            ...
            async def list_models(self, **kwargs) -> List[ModelInfo]:
                self.call_count += 1
                return [
                    ModelInfo(id=f"model-{self.call_count}", name=f"Model {self.call_count}", provider="test")
                ]
...
class TestProviderRegistry:
    ...
    async def test_registry_list_all_models(self):
        ...
        class Provider1(ModelProvider):
            async def list_models(self, **kwargs) -> List[ModelInfo]:
                return [
                    ModelInfo(id="p1-model1", name="Provider1 Model1", provider="provider1"),
                    ModelInfo(id="p1-model2", name="Provider1 Model2", provider="provider1")
                ]
        ...
        class Provider2(ModelProvider):
            async def list_models(self, **kwargs) -> List[ModelInfo]:
                return [
                    ModelInfo(id="p2-model1", name="Provider2 Model1", provider="provider2")
                ]
    ...
    async def test_registry_list_provider_models(self):
        ...
        class TestProvider(ModelProvider):
            async def list_models(self, **kwargs) -> List[ModelInfo]:
                return [
                    ModelInfo(id="test-model", name="Test Model", provider="test")
                ]
    ...
    async def test_registry_handle_provider_errors(self):
        ...
        class WorkingProvider(ModelProvider):
            async def list_models(self, **kwargs) -> List[ModelInfo]:
                return [
                    ModelInfo(id="working-model", name="Working Model", provider="working")
                ]
