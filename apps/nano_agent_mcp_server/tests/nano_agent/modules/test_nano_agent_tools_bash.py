...
from nano_agent.modules.data_types import BashCommandRequest, BashCommandResponse
...
class TestBashCommandRaw:
    ...
    def test_exception_handling(self):
        ...
        with patch('nano_agent.modules.nano_agent_tools._bash_command_impl') as mock_impl:
