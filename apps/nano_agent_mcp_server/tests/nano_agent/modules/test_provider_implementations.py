...
from nano_agent.modules.provider_implementations import (
    OpenAIProvider,
    AnthropicProvider,
    OllamaProvider,
    LMStudioProvider,
...
from nano_agent.modules.model_providers import (
    ModelInfo,
...
class TestOpenAIProvider:
    ...
    @pytest.mark.asyncio
    @patch('nano_agent.modules.provider_implementations.aiohttp.ClientSession')
    ...
    async def test_list_models_authentication_error(self, mock_session_class):
        ...
        assert "openai" in str(exc_info.value).lower() or exc_info.value.provider == "openai"
...
class TestOllamaProvider:
    ...
    async def test_list_models_connection_error(self, mock_session_class):
        ...
        assert "ollama" in str(exc_info.value).lower() or exc_info.value.provider == "ollama"
...
class TestProviderInitialization:
    ...
    @pytest.mark.asyncio
    @patch('nano_agent.modules.provider_implementations.OllamaProvider.validate_connection')
    @patch('nano_agent.modules.provider_implementations.LMStudioProvider.validate_connection')
    ...
    def test_initialize_providers(self):
        ...
        from nano_agent.modules.model_providers import ProviderRegistry
