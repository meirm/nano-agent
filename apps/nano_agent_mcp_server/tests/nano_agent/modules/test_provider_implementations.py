...
import aiohttp
import pytest
from nano_agent.modules.model_providers import (ModelInfo,
                                                ProviderAuthenticationError,
                                                ProviderConnectionError,
                                                ProviderRateLimitError)
from nano_agent.modules.provider_implementations import (AnthropicProvider,
                                                         LMStudioProvider,
                                                         OllamaProvider,
                                                         OpenAIProvider,
...
class TestProviderInitialization:
    ...
    @pytest.mark.asyncio
    @patch(
        "nano_agent.modules.provider_implementations.OllamaProvider.validate_connection"
    )
    @patch(
        "nano_agent.modules.provider_implementations.LMStudioProvider.validate_connection"
    )
