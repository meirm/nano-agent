...
import pytest
from nano_agent.modules.files import (ensure_parent_exists,
...
class TestIntegration:
    ...
    def test_tool_with_relative_path(self):
        ...
        from nano_agent.modules.nano_agent_tools import (read_file_raw,
                                                         write_file_raw)
    ...
    def test_file_info_paths(self):
        ...
        from nano_agent.modules.nano_agent_tools import (get_file_info_raw,
                                                         write_file_raw)
